...
Read `{TEAM_DIRECTIVES}/CDR.md` and parse the CDR Index table into candidate records.
...
- Hardcoding the knowledge-base path instead of resolving `team_ai_directives` from `.adlc/init-options.json`.
