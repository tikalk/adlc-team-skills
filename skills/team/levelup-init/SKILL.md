...
Parse the JSON output for `REPO_ROOT`, `CDR_DRAFTS_DIR`, `TEAM_AI_DIRECTIVE`, `NEXT_CDR`, etc.
...
- `{TEAM_AI_DIRECTIVE}/context_modules/personas/*.md`
- `{TEAM_AI_DIRECTIVE}/context_modules/examples/**/*.md`
- `{TEAM_AI_DIRECTIVE}/skills/**/*`
...
### Context Type: Rule | Persona | Example | Skill | Constitution Creation | Constitution Amendment
