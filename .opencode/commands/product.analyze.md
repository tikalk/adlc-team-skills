---
description: Analyze product for consistency between PDRs and PRD, completeness, and
  quality issues
scripts:
...
1. **Run Setup Script**:
   - Execute `.specify/extensions/product/scripts/bash/setup-product.sh "analyze $ARGUMENTS"` from repo root
