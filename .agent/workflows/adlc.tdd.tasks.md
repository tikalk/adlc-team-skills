---
description: Detect language/framework and generate hybrid TDD tests (increment-based
  + risk-based)
scripts:
  sh: .specify/scripts/bash/detect-language.sh
  ps: .specify/scripts/powershell/Detect-Language.ps1
tools:
- bash
- jq
- yq
