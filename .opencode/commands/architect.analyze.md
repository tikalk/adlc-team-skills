---
description: Analyze architecture for consistency between ADRs and AD, completeness,
  and quality issues
scripts:
  sh: .specify/extensions/architect/scripts/bash/setup-architect.sh "analyze {ARGS}"
  ps: .specify/extensions/architect/scripts/powershell/setup-architect.ps1 "analyze
    {ARGS}"
---
...
1. **Run Setup Script**:
   - Execute `.specify/extensions/architect/scripts/bash/setup-architect.sh "analyze $ARGUMENTS"` from repo root
