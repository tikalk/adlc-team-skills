---
description: "Build a reusable skill from accepted CDRs for team AI directives.\n\
  Use when user requests \"build skill\", \"create skill from CDR\", \n\"package as\
  \ skill\", \"skill for {topic}\", or mentions creating\nreusable AI capabilities\
  \ from accepted design records. Input:\nskill name, CDR ID, or topic string. Only\
