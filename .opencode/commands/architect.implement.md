---
description: Generate full Architecture Description (AD.md) from ADRs using multi-agent
  DAG orchestration
scripts:
  sh: .specify/extensions/architect/scripts/bash/setup-architect.sh "implement {ARGS}"
  ps: .specify/extensions/architect/scripts/powershell/setup-architect.ps1 "implement
    {ARGS}"
---
...
Located in the extension's `.specify/templates/` directory:

| Template | Purpose |
|----------|---------|
| `.specify/templates/views/context.md` | Context View template |
| `.specify/templates/views/functional.md` | Functional View template |
| `.specify/templates/views/information.md` | Information View template |
| `.specify/templates/views/concurrency.md` | Concurrency View template (optional) |
| `.specify/templates/views/development.md` | Development View template |
| `.specify/templates/views/deployment.md` | Deployment View template |
| `.specify/templates/views/operational.md` | Operational View template (optional) |

| Perspective Templates (10 total) |
|-----------------------------------|
| `.specify/templates/perspectives/security.md` |
| `.specify/templates/perspectives/performance.md` |
| `.specify/templates/perspectives/accessibility.md` |
| `.specify/templates/perspectives/availability.md` |
| `.specify/templates/perspectives/evolution.md` |
| `.specify/templates/perspectives/internationalization.md` |
| `.specify/templates/perspectives/location.md` |
| `.specify/templates/perspectives/regulation.md` |
| `.specify/templates/perspectives/usability.md` |
| `.specify/templates/perspectives/development-resource.md` |
...
**Script Action**: Run `.specify/extensions/architect/scripts/bash/setup-architect.sh "implement $ARGUMENTS"` which calls `plan-dag` internally
...
3. **Load View Template**: Read from `.specify/templates/views/{view}.md`
...
**Template**: `.specify/templates/views/context.md`
**Key Content**:
...
**Template**: `.specify/templates/views/functional.md`
**Key Content**:
...
**Template**: `.specify/templates/views/information.md`
**Key Content**:
...
**Template**: `.specify/templates/views/concurrency.md`
...
**Template**: `.specify/templates/views/development.md`
**Key Content**:
...
**Template**: `.specify/templates/views/deployment.md`
**Key Content**:
...
**Template**: `.specify/templates/views/operational.md`
...
#### Security Perspective (`.specify/templates/perspectives/security.md`)

- Authentication & authorization approach
- Data protection measures
- Threat model table

#### Performance Perspective (`.specify/templates/perspectives/performance.md`)
