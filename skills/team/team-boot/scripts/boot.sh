...
echo "| levelup-boot | CDR module bodies (team-ai-directives) | CDR descriptor match; reusable team pattern | direct write to .adlc/drafts/cdr/ |"
...
echo "| Reusable team rule, \"we always do X\" | pattern | drafts/cdr/ | /levelup-clarify |"
...
echo "- levelup: ../templates/cdr-draft-template.md"
