...
Section files in .adlc/product/sections/ are intermediate build artifacts only.
...
Detailed Product Decision Records are summarized below. Full PDR documents are maintained in the project's `.adlc/` directory.
...
- [ ] PRD is SELF-CONTAINED - no reader-facing links to .adlc/ files
