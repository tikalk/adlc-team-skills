...
Write-Output "| levelup-boot | CDR module bodies (team-ai-directives) | CDR descriptor match; reusable team pattern | direct write to .adlc/drafts/cdr/ |"
...
Write-Output "| Reusable team rule, \"we always do X\" | pattern | drafts/cdr/ | /levelup-clarify |"
...
Write-Output "- levelup: ../templates/cdr-draft-template.md"
