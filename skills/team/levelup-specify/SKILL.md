...
```bash
skills/levelup/levelup-specify/scripts/bash/setup-levelup-specify.sh
```
...
4. Most recently modified feature directory under `specs/` or `.adlc/drafts/`
...
### Source
Feature implementation evidence via /levelup-specify

### Target Module
`context_modules/rules/[domain]/[file].md` or `skills/[skill-name]/`

### Context Type
Rule | Persona | Example | Skill | Constitution Amendment
