---
description: Generate execution analysis + reports from evals/results/ → optional
  PR to team-ai-directives
scripts:
  sh: .specify/scripts/bash/setup-evals.sh "analyze {ARGS}"
  ps: .specify/scripts/powershell/setup-evals.ps1 "analyze {ARGS}"
---
...
.specify/scripts/bash/setup-evals.sh "analyze $ARGUMENTS" trace --assess-results
```
